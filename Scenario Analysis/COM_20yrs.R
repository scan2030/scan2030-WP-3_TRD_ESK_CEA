...
mat_antidepressant <- define_transition(
  ...
  0, p_3rdTX2RES*rr_COM_response, p_3rdTX2REM*rr_COM_remission, (1 - p_3rdTX2RES*rr_COM_response - p_3rdTX2REM*rr_COM_remission - p_death), 0, 0, 0, 0, 0, 0, 0, 0, p_death,
