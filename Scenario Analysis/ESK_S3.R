...
mod_antidepressant <- define_strategy(
  ...
  "3rd_TX" = define_state(
    cost = discount_cost(c_3rdOP + c_3rdIP + c_AD + c_ESK_SOPC1 + c_ESK_TX1, d_rate, model_time),
  ...
  "3rd_Response" = define_state(
    cost = discount_cost(
      ifelse(model_time == 1,
             c_3rdOP + c_AD + c_ESK_SOPC1 + c_ESK_TX1,
             ifelse(model_time >= 2 & model_time <= 6,
                    c_3rdOP + c_AD + c_ESK_SOPC2 + c_ESK_TX2,
                    c_3rdOP)
      ),
      d_rate,
      model_time
